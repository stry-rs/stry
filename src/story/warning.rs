use {
    ...
    stry_common::{models::Warning, backend::{BackendEntry, Id, New, Existing}},
};
...
impl BackendEntry<Warning, PostgresBackendError> for PostgresBackend {
    ...
    async fn all(&self, cursor: Id, limit: usize) -> Result<Vec<Existing<Warning>>, PostgresBackendError> {
        todo!()
    }
