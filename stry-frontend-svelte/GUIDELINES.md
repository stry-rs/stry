...
Tailwind class strings can get quite long so its better to spread them across multiple lines in order of category.

Use the [`Concentric-CSS`](https://github.com/brandon-rhodes/Concentric-CSS) ordering when possible.
